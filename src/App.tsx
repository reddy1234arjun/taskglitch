...
function AppContent() {
  ...
  const handleCloseUndo = useCallback(() => {
    // When the snackbar closes (manual or auto), clear the lastDeleted so undo is only available while snackbar is visible
    clearLastDeleted();
  }, [clearLastDeleted]);
  ...
  const handleUndo = useCallback(() => {
    undoDelete();
    // After undo, lastDeleted is cleared by undoDelete implementation
